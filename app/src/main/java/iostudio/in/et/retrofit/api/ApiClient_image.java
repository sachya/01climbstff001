...
public class ApiClient_image {
    ...
    private static ApiClient_image uniqInstance;
    private final String URL_SANDBOX = Constant.API.BASEURL2_API;
    private final String URL_SANDBOXTest = Constant.API.BASEURL2_API;
    private KApp apiKApp, apiKAppTest;

    public static synchronized ApiClient_image getInstance() {
        if (uniqInstance == null) {
            uniqInstance = new ApiClient_image();
        }
        return uniqInstance;
    }
