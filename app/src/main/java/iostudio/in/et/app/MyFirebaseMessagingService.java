...
import iostudio.in.et.activity.BaseActivity;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void updateDeviceIdToServer(String device_id) {
        try {
            Call<CommonResponse> call = ApiClient.getInstance().getApi().requestToUpdateFirebaseDeviceId(RetrofitRequest.getUpdateFirebaseDeviceIdRequest(device_id, Utility.getUserID(getApplicationContext())));
                    ...
                    if (response != null) {
                        try {
                            if (!TextUtils.isEmpty(response.getMessage()))
                                Utility.showMessage(getApplicationContext(), response.getMessage());
